...
resource "azurerm_monitor_autoscale_setting" "ui-vmss-config" {
  name                = "${local.group_name}-ui-vmss-config"
  resource_group_name = azurerm_resource_group.rg.name
  location            = azurerm_resource_group.rg.location
  target_resource_id  = azurerm_linux_virtual_machine_scale_set.ui-vmss.id
  ...
  profile {
    ...
    rule {
      ...
      metric_trigger {
        ...
        metric_resource_id = azurerm_linux_virtual_machine_scale_set.ui-vmss.id
